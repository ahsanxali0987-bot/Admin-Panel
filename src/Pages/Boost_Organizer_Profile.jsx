      ...
      <div className="p-3">
        <div className="rounded-lg shadow-[0_0_10px_rgba(0,0,0,0.08)] bg-white p-5">
          ...
          <p className="text-[17px] text-center text-[#000000B2] font-semibold mt-10">
            Manage how Organizers can boost their profiles. Choose the display
            options and set the pricing for each plan.
          </p>
        </div>
      </div>
...
export default Boost_Organizer_Profile;
